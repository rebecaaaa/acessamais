...
if($_POST){
    ...
    if ($newpassword==$cpassword){
        ...
        $error='<label for="promter" class="form-label" style="color:rgb(255, 62, 62);text-align:center;">Erro! As senhas precisam ser iguais</label>';
    }
        ...
        <table border="0" style="width: 69%;">
            <tr>
                <td colspan="2">
                    ...
                    <p class="sub-text">Criar nova conta.</p>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="label-td" colspan="2">
                    <label for="newpassword" class="form-label">Criar nova senha: </label>
                </td>
            </tr>
            <tr>
                <td class="label-td" colspan="2">
            ...
            <tr>
                <td class="label-td" colspan="2">
                    <label for="cpassword" class="form-label">Confirme a senha: </label>
                </td>
            </tr>
            <tr>
                <td class="label-td" colspan="2">
