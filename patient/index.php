            ...
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row">
                    <td class="menu-btn menu-icon-doctor">
                        <a href="doctors.php" class="non-style-link-menu"><div><p class="menu-text">Junta médica</p></a></div>
                    </td>
                </tr>
                
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-session">
                        <a href="schedule.php" class="non-style-link-menu"><div><p class="menu-text">Agendamentos</p></div></a>
                    </td>
                </tr>
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-appoinment">
                        <a href="appointment.php" class="non-style-link-menu"><div><p class="menu-text">Meus agendamentos</p></a></div>
                    </td>
                </tr>
                <tr class="menu-row" >
                ...
                <tr>
                    ...
                    <tr>
                        <td >
                            ...
                            <p>Para olhar todas as opções clique em
                                <a href="doctors.php" class="non-style-link"><b>"Médicos"</b></a>  ou
                                <a href="schedule.php" class="non-style-link"><b>"Agenda"</b> </a><br>
                        ...
                        <table border="0" width="100%"">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p style="font-size: 20px;font-weight:600;padding-left: 40px;" class="anime">Na sua agenda</p>
                                    <center>
